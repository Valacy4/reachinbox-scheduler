...
// Note: Job processing and rate limiting are handled exclusively by the BullMQ worker above.
// Reconcile on startup (src/jobs/reconcile.ts) handles re-enqueuing any orphaned pending jobs.